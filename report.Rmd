...
Mit der Umfrage konnten 81 Teilnehmer erreicht werden. Bei den Befragten handelt es sich zum größten Teil um Studierende verschiedener Studienfächer. Die Teilnehmer wurden befragt, wie womit sie am häufigsten prokrastinieren. Die Ergenisse haben wir nach den Studiengängen geclustert. Hierbei ist, wie in den beiden Grafiken unten zu sehen ist, sehr interessant, dass sich über die verschiedenen Studienfächer, ähnliche Muster zeigen. Es lassen sich keine eindeutigen Unterschiede erkennen. Viel wird zum Beispiel mit Videos oder dem Smartphone, sowie mit Essen prokrastiniert und wenig beispielsweise mit shoppen. Jedoch haben wir leider nur für die MINT Fächer genügend Datenpunkte, um gute Aussagen über die Daten machen zu können.
...
Die 81 Teilnehmer teilen sich auf die Bereiche Mathe, Informatik und Naturwissenschaften (MINT) zu 43% auf und die anderen Fächen zu jeweils ca. 10%. 
