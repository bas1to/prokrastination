...
```{r, code = readLines("Abschluss_Studienbereiche.R"), echo=FALSE, fig.keep = "none"}
```
...
Als Wordcloud:
```{r, fig.align='center', fig.cap='Wordcloud für die genannten Prokrastinationseheimtipps'}
...
```{r, fig.align = 'center', comment = '', fig.keep = "none"}
plot.for.categories()
```
...
# Attachments
## Recruitment Letter
```{r, fig.align='center', fig.height=4, fig.width=3, fig.cap='Social Media Poster als Recruitment Letter'}
